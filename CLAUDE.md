...
lib/
  ...
  core/
    ...
    audio_controller.dart         # singleton: música de fundo/cutscene (loop) + SFX.
  ...
  features/
    ...
    cutscene/
      ...
      cutscene_script.dart         # roteiro = List<CutsceneFrame> (falas ainda PROVISÓRIAS)
